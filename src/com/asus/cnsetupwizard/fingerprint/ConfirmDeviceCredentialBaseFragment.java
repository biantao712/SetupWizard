 ...
 */
public abstract class ConfirmDeviceCredentialBaseFragment extends Fragment
    ...
    public void onViewCreated(View view,  Bundle savedInstanceState) {
        ...
        mFingerprintHelper = new FingerprintUiHelper(
                (TextView) view.findViewById(R.id.headerText), this, mEffectiveUserId);
    ...
    private void setWorkChallengeBackground(View baseView, int userId) {
        //View mainContent = getActivity().findViewById(com.a.R.id.main_content);
        //if (mainContent != null) {
