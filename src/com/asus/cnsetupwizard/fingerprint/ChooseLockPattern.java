 ...
 */
public class ChooseLockPattern extends BaseActivity {
    /**
    ...
    public static final String ACTION = "com.asus.cnsetupwizard.CHOOSELOCKPATTERN";
    ...
    public static final boolean DEFAULT_REQUIRE_PASSWORD = false;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //CharSequence msg = getText(R.string.accounts_preference_title);
        ...
        FragmentTransaction fragmentTransaction = fragmentManager
                .beginTransaction();
        fragmentTransaction.replace(R.id.fragment, new ChooseLockPatternFragment());
    ...
    public static class ChooseLockPatternFragment extends PreferenceFragment
        ...
        protected void setRightButtonEnabled(boolean enabled) {
            ...
            if(enabled){
                mFooterRightButton.setTextColor(getResources().getColor(R.color.button_enable_color));
            }else {
                mFooterRightButton.setTextColor(getResources().getColor(R.color.button_disable_color));
            }
        }
        ...
        protected LockPatternView.OnPatternListener mChooseNewLockPatternListener =
                new LockPatternView.OnPatternListener() {
                    ...
                    private void patternInProgress() {
                        mHeaderText.setText(R.string.pattern_info2);
                        mFooterText.setText("");
         ...
         */
        enum LeftButtonMode {
            Cancel(R.string.wifi_cancel, true),
            CancelDisabled(R.string.wifi_cancel, false),
            Retry(R.string.wifi_cancel, true),
            RetryDisabled(R.string.wifi_cancel, false),
        ...
        enum RightButtonMode {
            Continue(R.string.wifi_cancel, true),
            ContinueDisabled(R.string.wifi_cancel, false),
            Confirm(R.string.wifi_cancel, true),
            ConfirmDisabled(R.string.wifi_cancel, false),
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            mUserId = getCredentialOwnerUserId(getContext());
        ...
        public void onViewCreated(View view, Bundle savedInstanceState) {
            ...
            backIcon = (ImageView) view.findViewById(R.id.button_back);
                ...
                if (confirmCredentials) {
                    ...
                    boolean launchedConfirmationActivity =
                            mChooseLockSettingsHelper.launchConfirmationActivity(
                                    ...
                                    getString(R.string.screen_lock_now), true,
                                    mUserId);
        ...
        protected void updateStage(Stage stage) {
            ...
            if (stage == Stage.ChoiceTooShort) {
                mHeaderText.setText(
                        getResources().getString(R.string.pattern_info1));
            } else {
            ...
            setRightButtonText(R.string.to_next);
